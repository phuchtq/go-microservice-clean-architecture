...
const (
	RoleService_GetAllRoles_FullMethodName = "/pb.RoleService/GetAllRoles"
)
...
type RoleServiceClient interface {
	GetAllRoles(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RolesResp, error)
}
...
func (c *roleServiceClient) GetAllRoles(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RolesResp, error) {
...
type RoleServiceServer interface {
	GetAllRoles(context.Context, *emptypb.Empty) (*RolesResp, error)
...
func (UnimplementedRoleServiceServer) GetAllRoles(context.Context, *emptypb.Empty) (*RolesResp, error) {
...
func _RoleService_GetAllRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).GetAllRoles(ctx, req.(*emptypb.Empty))
	}
